...
from lightning_classify.data import OnepieceImageDataLoader_v2
...
class TestOnepieceImageDataLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.train_dir = Path(self.test_dir) / "train"
        self.val_dir = Path(self.test_dir) / "val"
        ...
        self.data_loader = OnepieceImageDataLoader_v2(root_path=self.test_dir, batch_size=2, num_workers=1)
